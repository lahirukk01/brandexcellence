...
@section('title', 'Brand Excellence Judge Score SME Entry R2')
...
@section('breadcrumbs')
    <li><a href="{{route('judge.sme.index_r2')}}">SME Entries R2</a></li>
    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <form action="{{ route('judge.sme.store_r2', $sme->id) }}" method="post">
                        @csrf
                        <div class="card-body">
