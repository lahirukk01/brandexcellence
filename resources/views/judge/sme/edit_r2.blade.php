...
@section('title', 'Brand Excellence Judge Edit SME Entry R2')
...
@section('breadcrumbs_title', 'SME Entries R2')

@section('breadcrumbs')
    <li><a href="{{route('judge.sme.index_r1')}}">SME Entries R2</a></li>
    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <form action="{{ route('judge.sme.update_r2', $sme->id) }}" method="post">
                        @csrf
                        <div class="card-body">
                                                    ...
                                                    <td colspan="9">
                                                        <div class="form-group">
                                                            <textarea name="good" id="" cols="30" rows="4" class="form-control"
                                                                      data-validation="required">{{ $smeScore->good }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="9">
                                                        <div class="form-group">
                                                            <textarea name="bad" id="" cols="30" rows="4" class="form-control"
                                                                      data-validation="required">{{ $smeScore->bad }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="9">
                                                        <div class="form-group">
                                                            <textarea name="improvement" id="" cols="30" rows="4" class="form-control"
                                                                      data-validation="required">{{ $smeScore->improvement }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <td colspan="6">Login Time: {{ $startEditing }}</td>
...
@section('scripts')
    ...
    <script>
        $('#entries-sme-r2-li').addClass('active')
        $('#round2-sme-li').addClass('active')
