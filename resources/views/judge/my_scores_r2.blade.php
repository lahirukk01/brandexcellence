...
@section('title', 'Brand Excellence Judge Scores R2')
...
@section('breadcrumbs')
    <li class="active">My Scores R2</li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Scored Entries R2</h3>
                    </div>
                    <div class="card-body">
                        <table id="judge-scored-entries-table" class="table table-striped table-bordered">
                            ...
                            @foreach ($brands as $b)
                                <tr>
                                    ...
                                    <td>
                                        <a class="mx-2 btn btn-primary" href="{{route('judge.show_score2', $b->id)}}">View</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
