...
@section('title', 'Brand Excellence Judge Show CSR Score R2')

@section('styles')
@endsection

@section('breadcrumbs_title', 'My Scores R2')

@section('breadcrumbs')
    <li><a href="{{route('judge.my_scores2')}}">My Scores R2</a></li>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center">{{ $csrScore->intent }}</td>
                                                <td class="text-center">{{ $csrScore->recipient }}</td>
                                                <td class="text-center">{{ $csrScore->purpose }}</td>
                                                <td class="text-center">{{ $csrScore->vision }}</td>
                                                <td class="text-center">{{ $csrScore->mission }}</td>
                                                <td class="text-center">{{ $csrScore->identity }}</td>
                                                <td class="text-center">{{ $csrScore->strategic }}</td>
                                                <td class="text-center">{{ $csrScore->activities }}</td>
                                                <td class="text-center">{{ $csrScore->communication }}</td>
                                                <td class="text-center">{{ $csrScore->internal }}</td>
                                                <td class="text-center">{{ $csrScore->total }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="9">
                                                    <div class="form-group">{{ $csrScore->good }}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">What is bad?</td>
                                                <td colspan="9">
                                                    <div class="form-group">{{ $csrScore->bad }}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">What needs to be improved?</td>
                                                <td colspan="9">
                                                    <div class="form-group">{{ $csrScore->improvement }}</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
@section('scripts')
    ...
    <script>
        $('#my-scores-r2-li').addClass('active')
    </script>
