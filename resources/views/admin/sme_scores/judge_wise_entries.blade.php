...
@section('title', 'Brand Excellence Judge Wise Entries SME')
                        ...
                        <table id="admin-brands-table" class="table table-striped table-bordered">
                            ...
                            @foreach ($smes as $b)
                                <tr>
                                    ...
                                    <td>{{ $b->company }}</td>
                                    <td>
                                        <a class="btn btn-primary" href="{{ route('admin.sme.score.show', ['judge' =>$judge->id, 'brand' => $b->id, 'direction' => 'judgewise']) }}">View</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
...
@section('scripts')
    ...
    <script>
        ...
        $('#judge-wise-sme-r1-li > i').css('color', 'white')
