...
@section('title', 'Brand Excellence Admin Show SME Score R2')
...
@section('breadcrumbs')
    ...
    <li><a href="{{route('admin.sme.score.entry_wise_judges_r2', $brand->id)}}">Entry Wise Judges</a></li>
    @else
    <li><a href="{{route('admin.sme.score.judge_wise_r2')}}">Judge Wise</a></li>
    <li><a href="{{route('admin.sme.score.judge_wise_entries_r2', $judge->id)}}">Judge Wise Entries</a></li>
    @endif
