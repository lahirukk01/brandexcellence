...
@section('content')
    <div class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form id="edit-brand-form" action="{{route('admin.brand.update', $brand->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="file" id="" name="supporting_material"
                                           class="form-control-file" accept="application/pdf" value=""
                                           data-validation="mime"
                                           data-validation-allowing="pdf" >
        ...
        $('#edit-brand-form').ajaxForm({
            ...
            complete: function(xhr, textStatus) {
                ...
                if(response.success !== undefined) {
                    ...
                    window.location.assign('{{route('admin.brand.index')}}')
                } else {
