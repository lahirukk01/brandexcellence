                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="designation" type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" value="{{ $user->designation }}" required autocomplete="designation">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="contact-no" type="text" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number" value="{{ $user->contact_number }}" required autocomplete="contact-number">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="company-name" type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ $user->company->name }}" required autocomplete="company-name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="company-address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $user->company->address }}" required autocomplete="address">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="ceo-name" type="text" class="form-control @error('ceo_name') is-invalid @enderror" name="ceo_name" value="{{ $user->company->ceo_name }}" required autocomplete="ceo-name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="ceo-email" type="text" class="form-control @error('ceo_email') is-invalid @enderror" name="ceo_email" value="{{ $user->company->ceo_email }}" required autocomplete="ceo-email">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="ceo-name" type="text" class="form-control @error('ceo_contact_number') is-invalid @enderror" name="ceo_contact_number" value="{{ $user->company->ceo_contact_number }}" required autocomplete="ceo-contact-number">
...
{{--                                <form action="{{route('client.self_update_password', $user->id)}}" method="post">--}}
{{--                                    @csrf--}}
{{--                                    @method('PATCH')--}}

{{--                                    <div class="form-group row">--}}
{{--                                        <label for="old-password" class="col-md-4 col-form-label text-md-right">{{ __('Current Password (Alpha Numeric)') }}</label>--}}
